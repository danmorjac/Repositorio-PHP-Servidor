...
// Aqui NO informaremos del usuario y su tipo, pues puede cambiar en la identificaci�n del usuario.
?>

<html>

<head>
	<title>ANUNCIOS - Identificacion y Tablon de Anuncios</title>
</head>
...
<body>
	...
	if (isset($_POST['usuario']) && isset($_POST['clave'])) {
		// Si ambos campos del formulario estan rellenos... (si no son cadena vac�a)
	...
	if (!$conexion) {
		...
		if (!$resultado) {
			...
			while ($fila = mysqli_fetch_array($resultado)) {
				...
				{
					// En el enlace enviamos el id por el metodo GET a la pagina eliminar.php.
